...
export PATH=$HOME/bin:/usr/local/bin:$PATH:$HOME/.gem/ruby/2.6.0/bin:/usr/local/bin/pip:$HOME/.local/bin:$HOME/opt/bin
...
alias luks_CA='function _luks_CA() { sudo umount ~/Media/Luks/$1; sudo cryptsetup luksClose $1;}; _luks_CA'
...
alias incog='fc -p'
alias audio_hdmi='pactl set-default-sink 0'
alias audio_analog='pactl set-default-sink 1'
